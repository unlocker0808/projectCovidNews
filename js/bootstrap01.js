...
+(function (a) {
  ...
  (d.VERSION =
    '3.3.1'), (d.TRANSITION_DURATION = 150), (d.prototype.close = function (b) {
    function c () {
  ...
  (a.fn.button = b), (a.fn.button.Constructor = c), (a.fn.button.noConflict = function () {
    ...
    .on ('click.bs.button.data-api', '[data-toggle^="button"]', function (c) {
      var d = a (c.target);
      d.hasClass ('btn') ||
        (d = d.closest ('.btn')), b.call (d, 'toggle'), c.preventDefault ();
    })
    .on (
  ...
  var c = function (b, c) {
    (this.$element = a (b)), (this.$indicators = this.$element.find (
      '.carousel-indicators'
    )), (this.options = c), (this.paused = this.sliding = this.interval = this.$active = this.$items = null), this
      .options.keyboard &&
      this.$element.on (
        'keydown.bs.carousel',
    ...
    if ((this.$element.trigger (l), !l.isDefaultPrevented ())) {
      ...
      return a.support.transition && this.$element.hasClass ('slide')
        ? (f.addClass (b), f[0].offsetWidth, e.addClass (h), f.addClass (h), e
            .one ('bsTransitionEnd', function () {
              f
                ...
                .addClass (
                  'active'
                ), e.removeClass (['active', h].join (' ')), (j.sliding = !1), setTimeout (function () {
                j.$element.trigger (n);
              }, 0);
            })
        ...
        : (e.removeClass ('active'), f.addClass (
            'active'
          ), (this.sliding = !1), this.$element.trigger (n)), g &&
        this.cycle (), this;
    }
  });
  var d = a.fn.carousel;
  ...
  (g.VERSION = '3.3.1'), (g.prototype.toggle = function (d) {
    ...
    if (
      ...
      var d = a (this);
      if (
        (b.preventDefault (), b.stopPropagation (), !d.is (
          '.disabled, :disabled'
        ))
      ) {
        var e = c (d), g = e.hasClass ('open');
        if ((!g && 27 != b.which) || (g && 27 == b.which))
          return 27 == b.which && e.find (f).trigger ('focus'), d.trigger (
            'click'
          );
  ...
  var c = function (b, c) {
    (this.options = c), (this.$body = a (document.body)), (this.$element = a (
      b
    )), (this.$backdrop = this.isShown = null), (this.scrollbarWidth = 0), this
      .options.remote &&
  ...
  (c.VERSION =
    '3.3.1'), (c.TRANSITION_DURATION = 300), (c.BACKDROP_TRANSITION_DURATION = 150), (c.DEFAULTS = {
    backdrop: !0,
    keyboard: !0,
    show: !0,
    ...
    this.$element.trigger (e), this.isShown ||
      ...
      ((this.isShown = !0), this.checkScrollbar (), this.setScrollbar (), this.$body.addClass (
        ...
        d.$element.parent ().length ||
          d.$element.appendTo (
            d.$body
          ), d.$element.show ().scrollTop (0), d.options.backdrop && d.adjustBackdrop (), d.adjustDialog (), e && d.$element[0].offsetWidth, d.$element.addClass ('in').attr ('aria-hidden', !1), d.enforceFocus ();
    ...
    (this.bodyIsOverflowing =
      ...
      document.documentElement
        .clientHeight), (this.scrollbarWidth = this.measureScrollbar ());
  ...
  (c.VERSION = '3.3.1'), (c.TRANSITION_DURATION = 150), (c.DEFAULTS = {
    ...
    return c && c.$tip && c.$tip.is (':visible')
      ...
      : (c ||
          ...
          )), a (b.currentTarget).data ('bs.' + this.type, c)), clearTimeout (
          c.timeout
        ), (c.hoverState = 'in'), c.options.delay && c.options.delay.show
    ...
    isNaN (g) && (g = 0), isNaN (h) && (h = 0), (b.top = b.top + g), (b.left =
      b.left + h), a.offset.setOffset (
      d[0],
      a.extend (
        {
          using: function (a) {
  ...
  (c.VERSION = '3.3.1'), (c.DEFAULTS = a.extend (
    {},
  ...
  (b.VERSION = '3.3.1'), (b.DEFAULTS = {
    ...
    a.isWindow (this.$scrollElement[0]) ||
      ((b =
        'position'), (c = this.$scrollElement.scrollTop ())), (this.offsets = []), (this.targets = []), (this.scrollHeight = this.getScrollHeight ());
    var d = this;
    this.$body
      .find (this.selector)
      .map (function () {
  ...
  function b (b) {
    return this.each (function () {
      ...
      e ||
        d.data ('bs.tab', (e = new c (this))), 'string' == typeof b && e[b] ();
    });
  }
  var c = function (b) {
    this.element = a (b);
  ...
  (c.VERSION =
    '3.3.1'), (c.TRANSITION_DURATION = 150), (c.prototype.show = function () {
    var b = this.element,
