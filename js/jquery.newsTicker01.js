...
(function (b, k, l, m) {
  ...
  g.prototype = {
    ...
    stop: function () {
      this.state &&
        (clearInterval (
          this.moveInterval
        ), (this.state = 0), this.options.stop ());
    },
    resetInterval: function () {
      this.state &&
        (clearInterval (this.moveInterval), (this.moveInterval = setInterval (
          function () {
            this.move ();
          }.bind (this),
    ...
    moveDown: function () {
      this.moving ||
        ((this.moving = 1), this.options.movingDown (), this.$el
          .children ('li:last')
          .detach ()
          .prependTo (this.$el)
  ...
  b.fn[d] = function (a) {
    ...
    return this.each (function () {
      ...
      'string' === typeof a &&
        e[a].apply (e, Array.prototype.slice.call (f, 1));
    });
  };
